...
From the command line, with the experiment directory as the working directory:
    ...
    cd experiments/classical_control/dqn_cartpole
    python ../../src/run_autoregressive_recurrence.py configs/config_autoregressive_recurrence.yaml

From a notebook:

    from run_autoregressive_recurrence import run_experiment
    run_directory, episode_rewards = run_experiment("configs/config_autoregressive_recurrence.yaml")

The run writes everything under <experiment dir>/cached/runs/<timestamp>/, including
...
def run_experiment(config_path="configs/config_autoregressive_recurrence.yaml",
...
def main():
    ...
    parser.add_argument("config", nargs="?",
                        default="configs/config_autoregressive_recurrence.yaml")
