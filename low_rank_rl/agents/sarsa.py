"""Tabular on-policy SARSA with discretised observations."""
...
class SarsaAgent(BaseAgent):
    ...
    def update(
        ...
        if done:
            ...
            td_target = reward + self.gamma * self.q_table[s_next][next_action]
    ...
    def __repr__(self) -> str:
        return f"SarsaAgent(n_actions={self.n_actions}, n_bins={self.n_bins}, eps={self.epsilon:.3f})"
